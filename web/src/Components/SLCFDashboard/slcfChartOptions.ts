...
export const totalProgrammesOptions: any = {
  ...
  yaxis: {
    ...
    // //   const hasData = totalProgrammesOptions.series.some((s: any) => s.data.length > 0);
    // //   return hasData ? undefined : 10; // Default max value if no data
    // // },
    // // eslint-disable-next-line no-use-before-define, @typescript-eslint/no-use-before-define
    // max: totalProgrammesOptions.series.length ? undefined : 10, // Set default range if no data
    // forceNiceScale: true, // Ensure scale looks good
    axisBorder: {
